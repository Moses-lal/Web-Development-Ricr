...
function About() {
  return (
    <>
    <div className="container-fluid bg-info-subtle p-3  dabba" id="about">
       <h3 className="text-primary-emphasis text-center mb-4">About Me</h3>


       <div className="d-flex gap-5 justify-content-center ">
      <div>
      <img src={moses} width="200px" height="200px" id="img" className="shadow align-content-lg-between" />
      </div>

      <div className="d-flex gap-1  ">
      <div className="conatiner border  shadow bg-success-subtle p-3">
